...
public class SavitskyGolayFilter extends Analyzer {
  private final int windowSize;
  private final int polynomialDegree;

  public SavitskyGolayFilter(
      String[] inputFiles,
      String[] inputColumns,
      String[] outputFiles,
      int windowSize,
  ...
  public SavitskyGolayFilter(String[] inputFiles, String[] inputColumns, String[] outputFiles) {
    super(inputFiles, inputColumns, outputFiles);
    this.windowSize = 300;
