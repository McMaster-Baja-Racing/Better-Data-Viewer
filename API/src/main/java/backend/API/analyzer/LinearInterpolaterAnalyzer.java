...
public class LinearInterpolaterAnalyzer extends Analyzer {
  ...
  public LinearInterpolaterAnalyzer(
      String[] inputFiles, String[] inputColumns, String[] outputFiles) {
  ...
  public List<List<String>> linearInterpolate(List<List<String>> data1, List<List<String>> data2) {
    ...
    // We're assuming that both series will have their independent variables in the same
    // column(probably 0), so just one independentColumn variable
  ...
  public static void main(String[] args) {
    ...
    LinearInterpolaterAnalyzer analyzer =
        new LinearInterpolaterAnalyzer(inputFiles, inputColumns, outputFiles);
    analyzer.analyze();
  }
}
