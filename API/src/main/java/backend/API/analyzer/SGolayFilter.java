...
public class SGolayFilter extends Analyzer {
    ...
    @Override
    public void analyze() {
        System.out.println("I so fussy wussy UwU. Applying Savitzky-Golay filter to " + super.inputFiles[0] + " to " + super.outputFiles[0] + " with window size " + windowSize + " and polynomial degree " + polynomialDegree);
