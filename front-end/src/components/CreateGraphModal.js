  ...
  const updatePage = (pageVar) => {
    ...
    if (displayPage === 2) {
      return (<FileStorage files={files} selectedFiles={selectedFiles} setSelectedFiles={setSelectedFiles} setColumns={setColumns} setDisplayPage={setDisplayPage}/>)
        ...
        return (<AnalyzersAndSeries dimensions={dimensions} columns={columns} setDisplayPage={setDisplayPage} setShowModal={setShowModal} handleSubmit={handleSubmit} setDimensions={setDimensions} graphType={graphType}/>)
    } else{
