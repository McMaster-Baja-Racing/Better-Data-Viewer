  ...
  return (
    <div className="App">
      ...
      <div className="App-body">
        ...
        {modal === 'Create' ? <CreateGraphModal setModal={setModal} setChartInformation={setChartInformation} setVideoInformation={setVideoInformation} setSuccessMessage={setSuccessMessage} chartInformation={chartInformation} buttonID={buttonID} /> : null}
