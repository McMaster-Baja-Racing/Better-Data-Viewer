...
public class AnalyzerExceptionInterceptor {
  ...
  public Object handleAnalyzerException(InvocationContext context) throws Exception {
    try {
      ...
      String msg = "Analyzer operation failed due to an invalid input file: "
          + context.getMethod().getName()
          + " - "
          + e.getMessage();
      ...
      String msg = "Analyzer operation failed due to an invalid output file: "
          + context.getMethod().getName()
          + " - "
          + e.getMessage();
      ...
      String msg = "Analyzer operation failed due to a header error: "
          + context.getMethod().getName()
          + " - "
          + e.getMessage();
      ...
      String msg = "Analyzer operation failed due to an invalid column: "
          + context.getMethod().getName()
          + " - "
          + e.getMessage();
